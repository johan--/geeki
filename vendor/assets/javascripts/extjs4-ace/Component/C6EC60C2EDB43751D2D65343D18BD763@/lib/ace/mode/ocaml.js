require.memoize(bravojs.realpath(bravojs.mainModuleDir + '/C6EC60C2EDB43751D2D65343D18BD763@/lib/ace/mode/ocaml'), ['pilot/oop','ace/mode/text','ace/tokenizer','ace/mode/ocaml_highlight_rules','ace/mode/matching_brace_outdent','ace/range'], function (require, exports, module) {
...
require.memoize(bravojs.realpath(bravojs.mainModuleDir + '/C6EC60C2EDB43751D2D65343D18BD763@/lib/ace/mode/ocaml_highlight_rules'), ['pilot/oop','pilot/lang','ace/mode/text_highlight_rules'], function (require, exports, module) {
({define:function(factory){var name, fExports = factory(require,exports,module); for(name in fExports) exports[name] = fExports[name]; }}).define(function(require, exports, module) {
...
__bravojs_loaded_moduleIdentifier = bravojs.realpath(bravojs.mainModuleDir + '/C6EC60C2EDB43751D2D65343D18BD763@/lib/ace/mode/ocaml');