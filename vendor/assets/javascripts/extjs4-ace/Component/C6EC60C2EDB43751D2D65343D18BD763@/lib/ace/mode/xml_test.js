require.memoize(bravojs.realpath(bravojs.mainModuleDir + '/C6EC60C2EDB43751D2D65343D18BD763@/lib/ace/mode/xml_test'), ['ace/edit_session','ace/tokenizer','ace/mode/xml','ace/test/assertions','asyncjs'], function (require, exports, module) {
...
require.memoize(bravojs.realpath(bravojs.mainModuleDir + '/C6EC60C2EDB43751D2D65343D18BD763@/lib/ace/mode/xml'), ['pilot/oop','ace/mode/text','ace/tokenizer','ace/mode/xml_highlight_rules'], function (require, exports, module) {
({define:function(factory){var name, fExports = factory(require,exports,module); for(name in fExports) exports[name] = fExports[name]; }}).define(function(require, exports, module) {
...
__bravojs_loaded_moduleIdentifier = bravojs.realpath(bravojs.mainModuleDir + '/C6EC60C2EDB43751D2D65343D18BD763@/lib/ace/mode/xml_test');